...
USE lecture;
create table if not exists attender (attender_number varchar(5), attender_id bigint not null auto_increment, created_at datetime(6), updated_at datetime(6), name varchar(255), tel varchar(255), primary key (attender_id)) engine=InnoDB
